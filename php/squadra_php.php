...
require_once "connessione.php"; //DIRECTORY_SEPARATOR è una costante che contiene il separatore di directory del sistema operativo
...
if ($connOk) {
  ...
  $stringaGiocatori = "<span>Collegamento al database non riuscito</span>"; #manda una mail all'amministratore per avvisarlo
